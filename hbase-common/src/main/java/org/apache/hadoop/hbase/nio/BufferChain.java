...
public class BufferChain {
  ...
  public BufferChain(ByteBuffer... buffers) {
   ...
   * @throws IOException
   */
  public long write(GatheringByteChannel channel, int chunkSize) throws IOException {
    ...
    long ret = 0;
    try {
      ret = channel.write(buffers, bufferOffset, bufCount);
      if (ret > 0) {
