...
public abstract class ByteBufferKeyValueWithoutSeqId extends ByteBufferExtendedCell {
  ...
  public ByteBufferKeyValueWithoutSeqId(ByteBuffer buf, int offset, int length) {
    this.buf = buf;
    this.offset = offset;
    this.length = length;
  }
