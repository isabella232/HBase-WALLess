...
public class ReplicaGoodStateMarkerHandler extends EventHandler {
  ...
  private final RegionInfo replicaRegion;
  private final HRegion primaryRegion;

  public ReplicaGoodStateMarkerHandler(HRegionServer server, RegionInfo replicaRegion,
  ...
  public void process() throws IOException {
    List<RegionInfo> lst = new ArrayList<>(1);
