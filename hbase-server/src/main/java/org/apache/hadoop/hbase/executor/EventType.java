...
public enum EventType {
  ...
  RS_REGION_REPLICA_MEMSTORE_ASYNC_ADD (85, ExecutorType.RS_REGION_REPLICA_MEMSTORE_ASYNC_ADD),

  RS_REGION_REPLICA_GOOD_HEALTH_MARKER(86, ExecutorType.RS_REGION_REPLICA_GOOD_HEALTH_MARKER_OPS);
