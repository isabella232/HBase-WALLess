...
public class ReplicaHealthCorrectionHandler extends EventHandler {
  ...
  private final List<Pair<HRegionInfo, Long>> regions;

  public ReplicaHealthCorrectionHandler(RegionReplicaHealthManager replicaHealthManager,
      HMaster master, EventType eventType, ServerName sn, List<Pair<HRegionInfo, Long>> regions) {
  ...
  public void process() throws IOException {
    try {
      ...
      List<HRegionInfo> downRegions = new ArrayList<>(this.regions.size());
